...
<div class="header-area">
    ...
    <label class="exit-btn-label" for="exit-btn">{{ __('EXIT') }}</label>
    <div class="exit">
        <button id="exit-btn" type="submit" onclick="location.href='{{ route('admin.exit') }}'">
            <svg version="1.1" id="_x32_" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 512 512" xml:space="preserve">
                <g>
                    <path class="st0" d="M180.154,101.188c27.934,0,50.598-22.656,50.598-50.598c0-27.942-22.665-50.59-50.598-50.59
                        c-27.942,0-50.59,22.648-50.59,50.59C129.564,78.532,152.211,101.188,180.154,101.188z" style="fill: rgba(110, 180, 100, 1);"></path>
                    <path class="st0" d="M466.439,366.826l-102.347-4.504l-3.219-72.381c-0.126-1.445-0.361-2.857-0.664-4.26
                        ...
                        c14.168,0,25.664-11.497,25.664-25.666C492.104,378.314,480.608,366.826,466.439,366.826z" style="fill: rgba(110, 180, 100, 1);"></path>
                </g>
            </svg>
        </button>
    </div>
